...
contract MarketPlace {
  ...
  */
  ...
  function list(string memory eventName, uint256 tokenId, uint256 price) 
    public
  {
  ...
  function unlist(string memory eventName, uint256 tokenId) 
    public
  {
    Event listedEvent = events[eventName];
    /*
  ...
  function buy(string memory eventName, uint256 tokenId)
    public 
  {
    // same require event exists
    Event listedEvent = events[eventName];
